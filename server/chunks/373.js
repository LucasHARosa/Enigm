...
__webpack_require__.d(__webpack_exports__, {
  "vy": () => (/* binding */ checkWin),
  "F5": () => (/* binding */ checkWord),
  "iJ": () => (/* binding */ getAvailableTiles),
  "tO": () => (/* binding */ getCopyPaste),
  "be": () => (/* binding */ getDailyWord),
  "WC": () => (/* binding */ getGameWord),
  "$o": () => (/* binding */ getLocalStorage),
  "Co": () => (/* binding */ loadGameData),
  "T3": () => (/* binding */ saveGameData),
  "zT": () => (/* binding */ saveGameWord),
  "_N": () => (/* binding */ toastError),
  "yd": () => (/* binding */ validateWord)
});

// EXTERNAL MODULE: external "react-hot-toast"
var external_react_hot_toast_ = __webpack_require__(922);
...
;// CONCATENATED MODULE: ./lib/targetWords.ts
const targetWords = [
    "AARAO",
    "ABNER",
    "ACAIA",
...
;// CONCATENATED MODULE: ./lib/helpers.ts



function getAvailableTiles(rowGuess) {
    let availableTiles = [];
...
function checkWin(word, dailyWord) {
...
function checkWord(word, dailyWord) {
    // 1: Not in Word
...
function toastError(message) {
    external_react_hot_toast_default().error(message, {
        style: {
...
function loadGameData(gameData, setters) {
...
function getCopyPaste(wordColors) {
    const noZeros = wordColors.filter((el)=>el !== 0
    );
    let numOfRows = noZeros.length / 5;
    let num = numOfRows;
    let hasWon = false;
    let lastRow;
    if (numOfRows === 6) {
    ...
    noZeros.forEach((el, index)=>{
        switch(el){
            case 1:
                copyPaste += indexes.includes(index + 1) ? "⬛️\n" : "⬛️";
                break;
            case 2:
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "gameEndedContext": () => (/* binding */ gameEndedContext)
});
...
;// CONCATENATED MODULE: ./components/tutorialModal/Tutorial.tsx


function Tutorial({ isOpen , onRequestClose  }) {
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)((external_react_modal_default()), {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                children: "Voc\xea tem 6 tentativas para acertar a palavra"
            }),
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                children: [
                    ...
                    " est\xe3o na posi\xe7\xe3o correta."
                ]
            }),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                children: [
                    ...
                    " est\xe3o em outra posi\xe7\xe3o."
                ]
            }),
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                children: [
...
// EXTERNAL MODULE: ./lib/helpers.ts + 2 modules
var helpers = __webpack_require__(482);
;// CONCATENATED MODULE: ./components/endModal/EndScreen.tsx



function EndScreen({ isOpen , onRequestClose , dailyWord , wordColors  }) {
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)((external_react_modal_default()), {
        isOpen: isOpen,
        onRequestClose: onRequestClose,
        overlayClassName: "react-modal-overlay",
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("button", {
                className: "share",
                onClick: ()=>(0,helpers/* getCopyPaste */.tO)(wordColors)
                ,
                children: "Copiar Resultado"
            }),
...
// EXTERNAL MODULE: external "react-particles"
var external_react_particles_ = __webpack_require__(979);
var external_react_particles_default = /*#__PURE__*/__webpack_require__.n(external_react_particles_);
// EXTERNAL MODULE: external "tsparticles-slim"
var external_tsparticles_slim_ = __webpack_require__(998);
;// CONCATENATED MODULE: ./components/Particles/particlesAmong.tsx




function ParticleAmong() {
    const particlesInit = (0,external_react_.useCallback)(async (engine)=>{
        await (0,external_tsparticles_slim_.loadSlim)(engine);
    }, []);
    const particlesLoaded = (0,external_react_.useCallback)(async (container)=>{}, []);
    return(/*#__PURE__*/ jsx_runtime_.jsx((external_react_particles_default()), {
        id: "tsparticles",
        init: particlesInit,
...
const gameEndedContext = /*#__PURE__*/ (0,external_react_.createContext)({});
function MyApp({ Component , pageProps  }) {
    const { 0: isOpen , 1: setIsOpen  } = (0,external_react_.useState)(true);
    const { 0: isEndOpen , 1: setIsEndOpen  } = (0,external_react_.useState)(false);
    const { 0: dailyWord , 1: setDailyWord  } = (0,external_react_.useState)("");
    const { 0: wordColors , 1: setWordColors  } = (0,external_react_.useState)([]);
    const { 0: gameEnded , 1: setGameEnded  } = (0,external_react_.useState)(false);
    (0,external_react_.useEffect)(()=>{
        ...
        const word = (0,helpers/* getGameWord */.WC)() || "";
        setDailyWord(word);
    }, []);
    (0,external_react_.useEffect)(()=>{
    ...
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(gameEndedContext.Provider, {
                value: {
                    gameEnded,
                    setGameEnded
                },
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(EndScreen, {
                        isOpen: isEndOpen,
                        onRequestClose: handleCloseEndScreen,
                        dailyWord: dailyWord,
                        wordColors: wordColors
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(Tutorial, {
                        isOpen: isOpen,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(ParticleAmong, {})
        ]
    }));
}
